 ...
 * @author vusyl
 */
public class DesignateController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Designate</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Designate at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<entity.Designate> list = ds.getDesignate();
        request.setAttribute("listDesignate", list);
        System.out.println(list);
        request.getRequestDispatcher("listDesignate.jsp").forward(request, response);
            } else {
