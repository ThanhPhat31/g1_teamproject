...
public class adminUpdateNews extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int id = Integer.parseInt(request.getParameter("nid"));
            ...
            request.setAttribute("news", s);
     
            request.getRequestDispatcher("admin-update-news.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        NewsDAO dao = new NewsDAO();
        dao.updateNews(n_id, category, title, content, date, author, img1, img2);
