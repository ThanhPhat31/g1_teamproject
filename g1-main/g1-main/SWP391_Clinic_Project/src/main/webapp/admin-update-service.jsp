    ...
    <body>
        ...
        <div class="container">
            <div class="card h-100">
                <form action="adminUpdateService" method="post">
                    <div class="card-body">
                        <div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input value="${service.serviceid}" type="text" class="form-control" name="id" >
                                </div>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input value="${service.description}" type="text" id="description" name="description"  class="form-control"  >
                                </div>
                            </div>   
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    <label for="content">Content</label>
                                    <input value="${service.content}" type="text" id="content" name="content"  class="form-control"  placeholder="">
                                </div>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    <label for="Image">Image</label>
                                    <div><img src="assets1/news/${service.image}" width="400px" height="200px"></div>
