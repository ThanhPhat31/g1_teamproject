...
<html>
    <head>
        ...
        <title>Admin List Service</title>        
        <!-- Boxicons -->
    ...
    <body> 
        ...
        <section id="content">
            ...
            <!--        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
                         Navbar Brand
                        <a class="navbar-brand ps-3" href="adminView.jsp">News manager</a>
                         Sidebar Toggle
            ...
            <div id="table-head">
                <main>
                    <div class="container-fluid px-4">
                            ...
                            <c:forEach items="${listService}" var="s">                               
                                <tbody>
                                    <tr class="align-items-center">
                                        <td class="text-center">${s.serviceid}</td>                                        
                                        <td class="text-center">${s.name}</td>
                                        <td class="text-center">${s.description}</td>                                       
                                        <td class="text-center">${s.content}</td>
                                        <td class="text-center"><img src="assets1/news/${s.image}" width="400px" height="200px"></td>
                                        <td class="text-center align-middle">
                                            <div class="btn-group align-top">

                                                <a class="btn btn-sm btn-outline-info" href="adminUpdateService?id=${s.serviceid}">Update</a>
                                                <a class="btn btn-sm btn-outline-secondary" href="adminDeleteService?id=${s.serviceid}">Delete</a>                                          
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <a class="btn btn-sm btn-outline-primary" href="admin-add-service.jsp">Add new service</a>
                </main>
            </div>
        </section>
        <!-- ================ -->
